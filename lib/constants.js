...
export const GET_DAILY_STOCK_NOTES = 'GET_DAILY_STOCK_NOTES';
export const GET_DAILY_STOCK_NOTES_RESPONSE = 'GET_DAILY_STOCK_NOTES_RESPONSE';
export const LOOKUP_SYMBOL = 'LOOKUP_SYMBOL';
export const LOOKUP_SYMBOL_RESPONSE = 'LOOKUP_SYMBOL_RESPONSE';
export const SET_DATE = 'SET_DATE';

export const SET_BET_VIEW_OPTIONS_FOOTBALL_DATE =
  'SET_BET_VIEW_OPTIONS_FOOTBALL_DATE';
export const SET_BET_VIEW_OPTIONS_FOOTBALL_GAME =
  'SET_BET_VIEW_OPTIONS_FOOTBALL_GAME';
export const SET_BET_VIEW_OPTIONS_BET_TYPE = 'SET_BET_VIEW_OPTIONS_BET_TYPE';
export const INITIALIZE_FOOTBALL_BET_OPTIONS =
  'INITIALIZE_FOOTBALL_BET_OPTIONS';
...
export const BET_TYPE_FOOTBALL_POINT_DIFFERENTIAL =
  'FOOTBALL_POINT_DIFFERENTIAL';
export const FOOTBALL_BET_TYPES = [
  BET_TYPE_FOOTBALL_TO_WIN,
  BET_TYPE_FOOTBALL_POINT_TOTAL,
  BET_TYPE_FOOTBALL_POINT_DIFFERENTIAL,
];
